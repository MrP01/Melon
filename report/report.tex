...
until convergence, repeat
  ...
  \label{sec:runtime}
  The following benchmarks were all accumulated on an Intel\textregistered \, i7-5600U CPU running at \SI{2.6}{\giga\hertz} verified through 3 individual runs, keeping parameters consistent along them.
